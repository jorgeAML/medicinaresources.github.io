$(document).ready(function () {
	...
	*/
	...
	$("<p/>", {
		href: "index_histo.html",
		"appendTo": ".mode-night",
		html: "<i class='icon-refresh'></i>&nbsp;&nbsp;&nbsp;Actualizado el 16 de Octubre 2017.",
	});
	$("<div/>", {
		"appendTo": ".row",
		"insertAfter": ".gad",
	...
	$("<div/>", {
		...
		"appendTo": ".col-sm-3",
		"insertAfter": ".iframe1",
		html: "<p>Comparte nuestra página con tus amigos.</p><iframe src='https://www.facebook.com/plugins/share_button.php?href=http%3A%2F%2Fwww.medicinaresources.com%2Fbioqui_books.html&layout=button_count&size=large&mobile_iframe=true&width=110&height=28&appId' width='110' height='28' style='border:none;overflow:hidden' scrolling='no' frameborder='0' allowTransparency='true'></iframe>",
